...
describe('getCharacterCoordinates', function() {
	it('should return', function() {
		let stencil = PNG.sync.read(fs.readFileSync('./test/numeric.png'));
		...
		assert.deepEqual(SpriteFont.getCharacterCoordinates(2, 5, 0), [0, 0]);
		assert.deepEqual(SpriteFont.getCharacterCoordinates(2, 5, 1), [0, 1]);
		assert.deepEqual(SpriteFont.getCharacterCoordinates(2, 5, 2), [0, 2]);
		assert.deepEqual(SpriteFont.getCharacterCoordinates(2, 5, 3), [0, 3]);
		assert.deepEqual(SpriteFont.getCharacterCoordinates(2, 5, 4), [0, 4]);
		assert.deepEqual(SpriteFont.getCharacterCoordinates(2, 5, 5), [1, 0]);
		assert.deepEqual(SpriteFont.getCharacterCoordinates(2, 5, 6), [1, 1]);
		assert.deepEqual(SpriteFont.getCharacterCoordinates(2, 5, 7), [1, 2]);
		assert.deepEqual(SpriteFont.getCharacterCoordinates(2, 5, 8), [1, 3]);
		assert.deepEqual(SpriteFont.getCharacterCoordinates(2, 5, 9), [1, 4]);
	});
	...
	it('should return', function() {
		...
		assert.deepEqual(SpriteFont.getCharacterCoordinates(
